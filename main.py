...
parser.add_argument('--snapshot', type=bool, default=True)  # 是否采用存储的最好结果
...
parser.add_argument('--DDP', default='True', help='whether DDP')
...
args_dir = str(args.data)+'_'+str(args.split)
